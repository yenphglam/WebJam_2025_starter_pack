    ...
    return (
        <>
            ...
            <div className={`${styles.infoSection} ${styles.faqBanner}`}>
                ...
                <button className={styles.quizButton} onClick={() => setCurrentPage("faq")}>Learn More</button>
            </div>
            <div className={`${styles.infoSection} ${styles.contactBanner}`}>
                ...
                <button className={styles.quizButton} onClick={() => setCurrentPage("contact")}>Contact Us</button>
            </div>
        </>
    );
}
